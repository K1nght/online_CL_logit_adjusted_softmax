...
class BlurryTinyImagenet(ContinualDataset):
    ...
    def __init__(self, args):
        ...
        super(BlurryTinyImagenet, self).__init__(args)
        ...
        self.train_dataset = MyTinyImagenet(base_path() + 'TINYIMG', train=True, download=True, 
                                            transform=self.TRANSFORM)

        self.test_dataset = TinyImagenet(base_path() + 'TINYIMG', train=False, download=True, 
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), BlurryTinyImagenet.TRANSFORM])
        return transform

    @staticmethod
    def get_aug_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), BlurryTinyImagenet.AUG_TRANSFORM])
        return transform

    @staticmethod
    def get_backbone():
        return resnet34(BlurryTinyImagenet.N_CLASSES)
    ...
    def get_minibatch_size():
        return BlurryTinyImagenet.get_batch_size()
